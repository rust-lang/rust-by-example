...
- [Scoping rules](scope.md)
    ...
    - [Borrowing](scope/borrow.md)
        - [Mutability](scope/borrowing/mut.md)
        - [Freezing](scope/borrowing/freeze.md)
        - [Aliasing](scope/borrowing/alias.md)
        - [The ref pattern](scope/borrowing/ref.md)
...
- [Error handling](error.md)
    ...
    - [Multiple error types](error/multiple_error_types.md)
        - [Early returns](error/multiple_error_types/early_returns.md)
        - [Introducing `try!`](error/multiple_error_types/enter_try.md)
...
- [Std library types](std.md)
    ...
    - [`panic!`](std/panic.md)
    - [HashMap](std/hash.md)
        - [Alternate/custom key types](std/alt_key_types.md)
        - [HashSet](std/hashset.md)
