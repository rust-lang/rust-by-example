...
Before there was `?`, pre-2017 code used the `try!` macro for the same
purpose. The `?` operator replaced it and is what you should use and
look for in modern code; there is no runnable example.
