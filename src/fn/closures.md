...
fn main() {
    ...
    // Once inferred, cannot infer another type.
    // Uncomment the line below to get a compiler error.
    //println!("closure_inferred, but another type: {}", closure_inferred(42i64));
